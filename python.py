...
kb.add_fact(("hadi", "adalah_orangtua_dari", "nikolas"))
kb.add_fact(("hadi", "adalah_orangtua_dari", "ardi"))
kb.add_fact(("retno", "adalah_orangtua_dari", "adiansah"))
kb.add_fact(("retno", "adalah_orangtua_dari", "wahyu"))
kb.add_fact(("retno", "adalah_orangtua_dari", "nikolas"))
...
kb.add_fact(("adiansah", "adalah_orangtua_dari", "tari"))
kb.add_fact(("adiansah", "adalah_orangtua_dari", "nurul"))
kb.add_fact(("adiansah", "adalah_orangtua_dari", "yanto"))
...
kb.add_fact(("nikolas", "adalah_orangtua_dari", "hamzah"))
...
kb.add_fact(("adiansah", "adalah_saudaraperempuan_dari", "nikolas"))
kb.add_fact(("nikolas", "adalah_saudaraperempuan_dari", "adiansah"))
...
kb.add_fact(("adiansah", "adalah_bibi_dari", "hamzah"))
kb.add_fact(("adiansah", "adalah_bibi_dari", "eka"))
kb.add_fact(("adiansah", "adalah_bibi_dari", "mira"))
kb.add_fact(("adiansah", "adalah_bibi_dari", "bastian"))
kb.add_fact(("nikolas", "adalah_bibi_dari", "tari"))
kb.add_fact(("nikolas", "adalah_bibi_dari", "nurul"))
kb.add_fact(("nikolas", "adalah_bibi_dari", "yanto"))
kb.add_fact(("nikolas", "adalah_bibi_dari", "eka"))
kb.add_fact(("nikolas", "adalah_bibi_dari", "mira"))
kb.add_fact(("nikolas", "adalah_bibi_dari", "bastian"))
...
kb.add_fact(("adiansah", "adalah_nenek_dari", "wanda"))
kb.add_fact(("adiansah", "adalah_nenek_dari", "aji"))
kb.add_fact(("adiansah", "adalah_nenek_dari", "gunawan"))
